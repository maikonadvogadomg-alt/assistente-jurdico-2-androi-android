# assistente-jurdico-2-androi — Projeto Android (Capacitor)

## Origem
GitHub: maikonadvogadomg-alt/assistente-jurdico-2-androi@main
...
## Configuração
- **Package:** `com.github.assistentejurdico2androi`
- **Versão:** 1.0.0 (code: 1)
- **Min SDK:** Android 22+
- **Orientação:** portrait
